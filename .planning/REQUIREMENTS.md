...
- [ ] **API-03**: Feed pagination uses cursor-based approach (stable when videos are added)
- [ ] **API-04**: Storage layer uses an abstraction interface (disk now, cloud-swappable later)
