...
**Domain:** Mobile-first short-form video player web app (static files, swipe feed)
**Researched:** 2026-04-01
**Confidence:** MEDIUM-HIGH (core choices HIGH, mobile wrapper deferred as LOW)
...
```bash
# Frontend scaffold
npm create vite@latest goonster-web -- --template react-ts
cd goonster-web
...
**For the vertical swipe feed (v1 core):**
...
**For static file serving (v1 backend):**
...
**For cloud storage migration (future):**
...
For this project size, a simple monorepo with two packages (`packages/web`, `packages/api`) under a pnpm workspace is the right call. It avoids the overhead of cross-repo dependency management and keeps video file paths relative. Do not over-engineer this with Nx or Turborepo for a two-package project.
...
*Stack research for: Goonster — mobile-first short-form video player*
*Researched: 2026-04-01*
