...
- **Global scope**: `/home/bfn/work/goonster/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/bfn/work/goonster/.claude/notes/`)
...
2. Glob `/home/bfn/work/goonster/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/bfn/work/goonster/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/bfn/work/goonster/.claude/notes/` — works in any directory
